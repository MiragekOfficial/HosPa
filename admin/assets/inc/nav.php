        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    <!-- item-->
                    <a href="add-employee" class="dropdown-item">
                    ...
                    <!-- item-->
                    <a href="add-payroll" class="dropdown-item">
                        <i class="fe-layers mr-1"></i>
                        <span>Payroll</span>
                    </a>

                    <!-- item-->
                    <a href="add-vendor" class="dropdown-item">
                    ...
                    <!-- item-->
                    <a href="add-medical-record" class="dropdown-item">
                    ...
                    <!-- item-->
                    <a href="surgery-records" class="dropdown-item">
